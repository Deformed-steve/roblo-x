  ...
  [2031], {
    ...
    28032: (t, e, i) => {
      ...
      var o = i(94907),
        ...
        R = t => {
          let {
            ...
            onOpenChange: s,
            modal: a = !1
          } = t, l = z(e), h = o.useRef(null), [d, c] = o.useState(!1), [f, g] = (0, m.i)({
            prop: r,
      ...
      o.forwardRef((t, e) => {
        ...
        return o.useEffect(() => (a(), () => l()), [a, l]), (0, y.jsx)(u.Mz, {
          ...s,
          ...r,
          ref: e
        })
      ...
      var E = "PopoverTrigger",
        M = o.forwardRef((t, e) => {
          let {
            __scopePopover: i,
            ...o
          } = t, s = P(E, i), a = z(i), l = (0, n.s)(e, s.triggerRef), h = (0, y.jsx)(f.sG.button, {
            type: "button",
            ...
            ...o,
            ref: l,
            onClick: (0, r.mK)(t.onClick, s.onOpenToggle)
          });
          return s.hasCustomAnchor ? h : (0, y.jsx)(u.Mz, {
            asChild: !0,
            ...a,
            children: h
          })
      ...
      H.displayName = A;
      var j = (0, g.TL)("PopoverContent.RemoveScroll"),
        k = o.forwardRef((t, e) => {
          ...
          return o.useEffect(() => {
            ...
            children: (0, y.jsx)(_, {
              ...
              onCloseAutoFocus: (0, r.mK)(t.onCloseAutoFocus, t => {
                var e;
                t.preventDefault(), l.current || null == (e = i.triggerRef.current) || e.focus()
              }),
              onPointerDownOutside: (0, r.mK)(t.onPointerDownOutside, t => {
              ...
              onFocusOutside: (0, r.mK)(t.onFocusOutside, t => t.preventDefault(), {
                checkForDefaultPrevented: !1
              })
            })
          })
        ...
        L = o.forwardRef((t, e) => {
          ...
          return (0, y.jsx)(_, {
            ...
            onCloseAutoFocus: e => {
              var o, s;
              null == (o = t.onCloseAutoFocus) || o.call(t, e), e.defaultPrevented || (r.current || null == (s = i.triggerRef.current) || s.focus(), e.preventDefault()), r.current = !1, n.current = !1
            },
            onInteractOutside: e => {
              var o, s;
              null == (o = t.onInteractOutside) || o.call(t, e), e.defaultPrevented || (r.current = !0, "pointerdown" === e.detail.originalEvent.type && (n.current = !0));
              let a = e.target;
              (null == (s = i.triggerRef.current) ? void 0 : s.contains(a)) && e.preventDefault(), "focusin" === e.detail.originalEvent.type && n.current && e.preventDefault()
            }
          })
        }),
        _ = o.forwardRef((t, e) => {
          ...
          return (0, l.Oh)(), (0, y.jsx)(h.n, {
            asChild: !0,
            loop: !0,
            trapped: o,
            onMountAutoFocus: r,
            onUnmountAutoFocus: n,
            children: (0, y.jsx)(a.qW, {
              asChild: !0,
              disableOutsidePointerEvents: s,
              onInteractOutside: f,
              onEscapeKeyDown: p,
      ...
      o.forwardRef((t, e) => {
        ...
        return (0, y.jsx)(f.sG.button, {
          ...
          ...o,
          ref: e,
          onClick: (0, r.mK)(t.onClick, () => n.onOpenChange(!1))
        })
      }).displayName = X;
    ...
    29561: (t, e, i) => {
      ...
      function l(t) {
        var e = (0, o.zs)((0, r.A)(a), 2),
          i = e[0],
          l = e[1];
        return (0, n.A)("mousemove", function(e) {
          var i = e.screenX,
            o = e.screenY,
            r = e.clientX,
            n = e.clientY,
          ...
          if (u) {
            var d = u.getBoundingClientRect(),
              ...
              g = d.width,
              m = d.height;
            p.elementPosX = c + window.pageXOffset, p.elementPosY = f + window.pageYOffset, p.elementX = a - p.elementPosX, p.elementY = h - p.elementPosY, p.elementW = g, p.elementH = m
          }
          l(p)
        }, {
          target: function() {
    ...
    60071: (t, e, i) => {
      ...
      Object.defineProperty(e, "__esModule", {
        value: !0
      }), e.addClassName = h, e.addEvent = function(t, e, i, o) {
        if (!t) return;
        let r = {
          capture: !0,
          ...o
        ...
        let e = t.clientHeight,
          i = t.ownerDocument.defaultView.getComputedStyle(t);
        return e += (0, o.int)(i.borderTopWidth), e += (0, o.int)(i.borderBottomWidth)
      }, e.outerWidth = function(t) {
        let e = t.clientWidth,
          i = t.ownerDocument.defaultView.getComputedStyle(t);
        return e += (0, o.int)(i.borderLeftWidth), e += (0, o.int)(i.borderRightWidth)
      }, e.removeClassName = p, e.removeEvent = function(t, e, i, o) {
        if (!t) return;
        let r = {
          capture: !0,
          ...o
      ...
      function a(t, e) {
        return s || (s = (0, o.findInArray)(["matches", "webkitMatchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector"], function(e) {
      ...
      function l(t, e, i) {
        let {
          x: o,
          y: r
        } = t, n = "translate(".concat(o).concat(i, ",").concat(r).concat(i, ")");
        if (e) {
    ...
    63435: (t, e, i) => {
      ...
      function o() {
        for (var t, e, i = 0, o = ""; i < arguments.length;)(t = arguments[i++]) && (e = function t(e) {
          var i, o, r = "";
          if ("string" == typeof e || "number" == typeof e) r += e;
          else if ("object" == typeof e)
            if (Array.isArray(e))
              for (i = 0; i < e.length; i++) e[i] && (o = t(e[i])) && (r && (r += " "), r += o);
            else
    ...
    65585: (t, e, i) => {
      ...
      let l = function(t, e) {
        ...
        var i = (0, o.zs)((0, r.A)(), 2),
          l = i[0],
          h = i[1],
          p = (0, n.A)(e);
        return (0, a.A)(function() {
          var e = (0, s.e)(t, document);
          if (e) {
            var i = function() {
              var t;
    ...
    67351: (t, e, i) => {
      ...
      class m extends o.Component {
        static getDerivedStateFromProps(t, e) {
          ...
          return i && (!o || i.x !== o.x || i.y !== o.y) ? ((0, u.default)("Draggable: getDerivedStateFromProps %j", {
            position: i,
            prevPropsPosition: o
          }), {
            x: i.x,
        ...
        constructor(t) {
          super(t), g(this, "onDragStart", (t, e) => {
            if ((0, u.default)("Draggable: onDragStart: %j", e), !1 === this.props.onStart(t, (0, l.createDraggableData)(this, e))) return !1;
            this.setState({
              dragging: !0,
              dragged: !0
            })
            ...
            let i = (0, l.createDraggableData)(this, e),
              o = {
                x: i.x,
                y: i.y,
                slackX: 0,
            ...
            if (this.props.bounds) {
              ...
              let [r, n] = (0, l.getBoundPosition)(this, o.x, o.y);
            ...
            if (!this.state.dragging || !1 === this.props.onStop(t, (0, l.createDraggableData)(this, e))) return !1;
        ...
        render() {
          let {
            ...
            scale: g,
            ...m
          } = this.props, b = {}, v = null, y = !d || this.state.dragging, w = d || r, x = {
            x: (0, l.canDragX)(this) && y ? this.state.x : w.x,
            y: (0, l.canDragY)(this) && y ? this.state.y : w.y
          };
          this.state.isElementSVG ? v = (0, a.createSVGTransform)(x, c) : b = (0, a.createCSSTransform)(x, c);
          let S = (0, s.default)(i.props.className || "", n, {
      ...
      e.default = m, g(m, "displayName", "Draggable"), g(m, "propTypes", {
        ...p.default.propTypes,
      ...
      Object.defineProperty(e, "__esModule", {
        ...
        if ("string" == typeof a) {
          let t, {
            ...
            i = e.defaultView;
          if (!((t = "parent" === a ? l.parentNode : e.querySelector(a)) instanceof i.HTMLElement)) throw Error('Bounds selector "' + a + '" could not find an element.');
          let n = i.getComputedStyle(l),
            s = i.getComputedStyle(t);
          a = {
            left: -l.offsetLeft + (0, o.int)(s.paddingLeft) + (0, o.int)(n.marginLeft),
            top: -l.offsetTop + (0, o.int)(s.paddingTop) + (0, o.int)(n.marginTop),
            right: (0, r.innerWidth)(t) - (0, r.outerWidth)(l) - l.offsetLeft + (0, o.int)(s.paddingRight) - (0, o.int)(n.marginRight),
            bottom: (0, r.innerHeight)(t) - (0, r.outerHeight)(l) - l.offsetTop + (0, o.int)(s.paddingBottom) - (0, o.int)(n.marginBottom)
          }
        }
        return (0, o.isNum)(a.right) && (e = Math.min(e, a.right)), (0, o.isNum)(a.bottom) && (i = Math.min(i, a.bottom)), (0, o.isNum)(a.left) && (e = Math.max(e, a.left)), (0, o.isNum)(a.top) && (i = Math.max(i, a.top)), [e, i]
    ...
    79802: (t, e, i) => {
      ...
      var o = i(94907),
        ...
        R = function(t) {
          function e(e) {
            ...
            return s.ratio = 1, s.resizable = null, s.parentLeft = 0, s.parentTop = 0, s.resizableLeft = 0, s.resizableRight = 0, s.resizableTop = 0, s.resizableBottom = 0, s.targetLeft = 0, s.targetTop = 0, s.delta = {
              ...
              return e.style.width = "100%", e.style.height = "100%", e.style.position = "absolute", e.style.transform = "scale(0, 0)", e.style.left = "0", e.style.flex = "0 0 100%", e.classList ? e.classList.add(P) : e.className += P, t.appendChild(e), e
          ...
          return f(e, t), Object.defineProperty(e.prototype, "parentNode", {
            ...
            get: function() {
              ...
              if (this.resizable && this.window) {
                ...
                "relative" !== r && (this.resizable.style.position = "relative"), t = "auto" !== this.resizable.style.width ? this.resizable.offsetWidth : i, e = "auto" !== this.resizable.style.height ? this.resizable.offsetHeight : o, this.resizable.style.position = r
              }
              return {
                width: t,
                height: e
            ...
            var i, o, r = this.props.boundsByDirection,
              n = this.state.direction,
              s = r && y("left", n),
              a = r && y("top", n);
            if ("parent" === this.props.bounds) {
              var l = this.parentNode;
              l && (i = s ? this.resizableRight - this.parentLeft : l.offsetWidth + (this.parentLeft - this.resizableLeft), o = a ? this.resizableBottom - this.parentTop : l.offsetHeight + (this.parentTop - this.resizableTop))
            } else "window" === this.props.bounds ? this.window && (i = s ? this.resizableRight : this.window.innerWidth - this.resizableLeft, o = a ? this.resizableBottom : this.window.innerHeight - this.resizableTop) : this.props.bounds && (i = s ? this.resizableRight - this.targetLeft : this.props.bounds.offsetWidth + (this.targetLeft - this.resizableLeft), o = a ? this.resizableBottom - this.targetTop : this.props.bounds.offsetHeight + (this.targetTop - this.resizableTop));
            ...
            var i, o = this.props.scale || 1,
              r = Array.isArray(i = this.props.resizeRatio || 1) ? i : [i, i],
              n = r[0],
              s = r[1],
              a = this.state,
              l = a.direction,
              ...
              m = d || 0,
              b = c || 0;
            return y("right", l) && (f = h.width + (t - h.x) * n / o, u && (g = (f - b) / this.ratio + m)), y("left", l) && (f = h.width - (t - h.x) * n / o, u && (g = (f - b) / this.ratio + m)), y("bottom", l) && (g = h.height + (e - h.y) * s / o, u && (f = (g - m) * this.ratio + b)), y("top", l) && (g = h.height - (e - h.y) * s / o, u && (f = (g - m) * this.ratio + b)), {
              newWidth: f,
              newHeight: g
            }
            ...
            if (n) {
              var f = (p - d) * this.ratio + c,
                ...
                y = Math.max(p, m),
                w = Math.min(u, v);
              t = b(t, Math.max(l, f), Math.min(h, g)), e = b(e, y, w)
            } else t = b(t, l, h), e = b(e, p, u);
            return {
              newWidth: t,
              newHeight: e
            }
            ...
            if (this.props.bounds && "string" != typeof this.props.bounds) {
              ...
              this.targetLeft = o.left * t, this.targetTop = o.top * t
            }
            if (this.resizable) {
              ...
              if (t.nativeEvent && ((i = t.nativeEvent).clientX || 0 === i.clientX) && (i.clientY || 0 === i.clientY) ? (r = t.nativeEvent.clientX, n = t.nativeEvent.clientY) : t.nativeEvent && w(t.nativeEvent) && (r = t.nativeEvent.touches[0].clientX, n = t.nativeEvent.touches[0].clientY), !this.props.onResizeStart || !this.resizable || !1 !== this.props.onResizeStart(t, e, this.resizable)) {
                ...
                if ("auto" !== s.flexBasis) {
                  ...
                  if (a) {
                    ...
                    this.flexDir = l.startsWith("row") ? "row" : "column", o = s.flexBasis
                  }
                }
            ...
            if (this.state.isResizing && this.resizable && this.window) {
              ...
              var i, o, r, n, s, l, h = this.props,
                ...
                R = (i = this.window.innerWidth, o = this.window.innerHeight, r = p, n = u, s = d, l = c, r = z(r, P.width, i, o), n = z(n, P.height, i, o), s = z(s, P.width, i, o), l = z(l, P.height, i, o), {
              ...
              this.props.snap && this.props.snap.x && (M = x(M, this.props.snap.x, this.props.snapGap)), this.props.snap && this.props.snap.y && (E = x(E, this.props.snap.y, this.props.snapGap));
              ...
              if (M = O.newWidth, E = O.newHeight, this.props.grid) {
              ...
              if (this.delta = k, S && "string" == typeof S) {
                if (S.endsWith("%")) {
                  var L = M / P.width * 100;
                  M = "".concat(L, "%")
              ...
              var B = this.state.width !== Y.width,
                ...
                G = B || F || U;
              G && (0, a.flushSync)(function() {
                e.setState(Y)
              }), this.props.onResize && G && this.props.onResize(t, b, this.resizable, k)
            }
          }, e.prototype.onMouseUp = function(t) {
            var e, i, o = this.state,
              r = o.isResizing,
              n = o.direction;
            o.original, r && this.resizable && (this.props.onResizeStop && this.props.onResizeStop(t, n, this.resizable, this.delta), this.props.size && this.setState({
            ...
            return (0, s.jsxs)(o, g({
              ...
              children: [this.state.isResizing && (0, s.jsx)("div", {
        ...
        C = function(t) {
          ...
          return N(i, t), i.prototype = null === t ? Object.create(t) : (e.prototype = t.prototype, new e), i.prototype.componentDidMount = function() {
            ...
            if (this.props.onDrag) {
              var i = this.offsetFromParent,
                o = i.left,
                r = i.top;
              if (!this.props.dragAxis || "both" === this.props.dragAxis) return this.props.onDrag(t, E(E({}, e), {
                x: e.x + o,
                y: e.y + r
              }));
              if ("x" === this.props.dragAxis) return this.props.onDrag(t, E(E({}, e), {
                x: e.x + o,
                y: this.originalPosition.y + r,
                deltaY: 0
              }));
              if ("y" === this.props.dragAxis) return this.props.onDrag(t, E(E({}, e), {
            ...
            if (this.props.onDragStop) {
              var i = this.offsetFromParent,
                o = i.left,
                r = i.top;
              if (!this.props.dragAxis || "both" === this.props.dragAxis) return this.props.onDragStop(t, E(E({}, e), {
                x: e.x + o,
                y: e.y + r
              }));
              if ("x" === this.props.dragAxis) return this.props.onDragStop(t, E(E({}, e), {
                x: e.x + o,
                y: this.originalPosition.y + r,
                deltaY: 0
              }));
              if ("y" === this.props.dragAxis) return this.props.onDragStop(t, E(E({}, e), {
                x: this.originalPosition.x + o,
                y: e.y + r,
                deltaX: 0
              }))
            ...
            if (this.resizingPosition = {
                x: n.x + r.left,
                y: n.y + r.top
              }, this.originalPosition = n, this.props.bounds) {
            ...
            var r = this,
              ...
              s = -o.width,
              l = -o.height;
            ["top", "left", "topLeft", "bottomLeft", "topRight"].includes(e) && ("bottomLeft" === e ? n.x += s : ("topRight" === e || (n.x += s), n.y += l));
            var h = this.draggable.state;
            (n.x !== h.x || n.y !== h.y) && (0, a.flushSync)(function() {
            ...
            var t, e = this,
              ...
              w = i.enableResizing,
              x = i.resizeGrid,
              S = i.resizeHandleWrapperClass,
              z = i.resizeHandleWrapperStyle,
              D = i.scale,
              P = i.allowAnyClick,
              N = i.dragPositionOffset,
              C = function(t, e) {
                var i = {};
      ...
      class g extends o.Component {
        constructor() {
          super(...arguments), d(this, "dragging", !1), d(this, "lastX", NaN), d(this, "lastY", NaN), d(this, "touchIdentifier", null), d(this, "mounted", !1), d(this, "handleDragStart", t => {
            ...
            if ((0, h.default)("DraggableCore: handleDrag: %j", r), !1 === this.props.onDrag(t, r) || !1 === this.mounted) {
              try {
    ...
    87441: (t, e, i) => {
      ...
      let n = function(t) {
        ...
        }) ? (e = (0, r.e)(i[0])) ? e.getRootNode() : document : document
      };
      var s = i(73229);
