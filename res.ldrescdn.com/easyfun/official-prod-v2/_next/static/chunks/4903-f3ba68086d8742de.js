    ...
    85188: (e, t, r) => {
        ...
        return e.prototype.parse = function() {
          ...
          switch (u) {
            ...
            case "time":
              ...
              if (f && J(null == f ? void 0 : f.style, "::", 0)) {
                ...
                var E = {
                  ...
                  parsedOptions: this.shouldParseSkeletons ? (d = {}, T.replace(L, function(e) {
                    var t = e.length;
                    switch (e[0]) {
                      case "G":
                      ...
                      case "h":
                        d.hourCycle = "h12", d.hour = ["numeric", "2-digit"][t - 1];
                        break;
                      case "H":
                        d.hourCycle = "h23", d.hour = ["numeric", "2-digit"][t - 1];
                        break;
                      case "K":
                        d.hourCycle = "h11", d.hour = ["numeric", "2-digit"][t - 1];
                        break;
                      case "k":
                        d.hourCycle = "h24", d.hour = ["numeric", "2-digit"][t - 1];
                        break;
                      case "j":
                      case "J":
                      case "C":
            ...
            case "select":
              ...
              if (this.bumpSpace(), !this.bumpIf(",")) return this.error(n.EXPECT_SELECT_ARGUMENT_OPTIONS, V(v, (0, c.Cl)({}, v)));
              this.bumpSpace();
              ...
              if ("select" !== u && "offset" === H.value) {
                ...
                if (m.err) return m;
                this.bumpSpace(), H = this.parseIdentifierIfPossible(), _ = m.val
              }
      ...
      function es(e, t) {
        ...
        return (null == t ? void 0 : t.captureLocation) || function e(t) {
          t.forEach(function(t) {
            ...
            else T(t) && S(t.style) || (v(t) || H(t)) && N(t.style) ? delete t.style.location : B(t) && e(t.children)
          })
        }(r.val), r.val
      }! function(e) {
      ...
      var ep = function() {
        function e(t, r, n, o) {
          ...
          this.formats = (a = e.formats, n ? Object.keys(a).reduce(function(e, t) {
            var r, i;
            return e[t] = (r = a[t], (i = n[t]) ? (0, c.Cl)((0, c.Cl)((0, c.Cl)({}, r || {}), i || {}), Object.keys(r).reduce(function(e, t) {
              return e[t] = (0, c.Cl)((0, c.Cl)({}, r[t]), i[t] || {}), e
            }, {})) : r), e
          }, (0, c.Cl)({}, a)) : a), this.formatters = o && o.formatters || (void 0 === (s = this.formatterCache) && (s = {
            number: {},
            dateTime: {},
            pluralRules: {}
          }), {
      ...
      function eN({
        ...
        let h = (0, l.useContext)(eS),
          u = (0, l.useMemo)(() => h?.cache || ed(), [n, h?.cache]),
          c = (0, l.useMemo)(() => h?.formatters || eH(u), [u, h?.formatters]),
          f = (0, l.useMemo)(() => ({
            ... function({
              formats: e,
      ...
      function eR() {
        ...
        return (0, l.useMemo)(() => (function(e) {
          ...
          function u(e, t, o) {
            return h(t, o, n?.dateTime, t => (t = s(t), r.getDateTimeFormat(i, t).format(e)), () => String(e))
          }
          ...
          return {
            ...
            relativeTime: function(e, t) {
              try {
                var n;
                let o, a, s = {};
                t instanceof Date || "number" == typeof t ? o = new Date(t) : t && (o = null != t.now ? new Date(t.now) : l(), a = t.unit, s.style = t.style, s.numberingSystem = t.numberingSystem), o || (o = l());
            ...
            list: function(e, t, o) {
              ...
              for (let t of e) {
                let e;
                "object" == typeof t ? (e = String(u), s.set(e, t)) : e = String(t), a.push(e), u++
              }
            ...
            dateTimeRange: function(e, t, o, a) {
              return h(o, a, n?.dateTime, n => (n = s(n), r.getDateTimeFormat(i, n).formatRange(e, t)), () => [u(e), u(t)].join(" – "))
            }
          }
        })({
          formats: e,
