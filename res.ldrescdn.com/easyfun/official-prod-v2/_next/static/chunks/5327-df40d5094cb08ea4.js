  ...
  [5327], {
    85327: (t, e, i) => {
        ...
        function s(s) {
          return function(l) {
            ...
            for (; r && (r = 0, d[0] && (o = 0)), o;) try {
              if (i = 1, n && (a = 2 & d[0] ? n.return : d[0] ? n.throw || ((a = n.return) && a.call(n), 0) : n.next) && !(a = a.call(n, d[1])).done) return a;
              switch (n = 0, a && (d = [2 & d[0], a.value]), d[0]) {
                case 0:
                case 1:
                  a = d;
                  break;
      ...
      var s = function(t) {
        ...
        w = function() {
          function t(e, i) {
            this.props = e, this.options = i, this.canvas = t.createCanvas(this.options.width, this.options.height), this.recommendOptions = g(this.canvas, this.options, this.props)
          }
          return t.createCanvas = function(t, e) {
            var i, n = window.devicePixelRatio || 1,
              a = document.createElement("canvas");
            return a.width = t * n, a.height = e * n, a.style.width = "".concat(t, "px"), a.style.height = "".concat(e, "px"), null == (i = a.getContext("2d")) || i.setTransform(n, 0, 0, n, 0, 0), a
            ...
            if (null == (e = this.options) ? void 0 : e.advancedStyle) switch (this.options.advancedStyle.type) {
              case "linear":
            ...
            t[i] && n && (t[i] = n), this.options.textAlign && (t.textAlign = this.options.textAlign), this.options.textBaseline && (t.textBaseline = this.options.textBaseline), t.globalAlpha = this.options.globalAlpha, this.options.shadowStyle && (t.shadowBlur = p(this.options.shadowStyle.shadowBlur, 0), t.shadowColor = p(this.options.shadowStyle.shadowColor, "#00000000"), t.shadowOffsetX = p(this.options.shadowStyle.shadowOffsetX, 0), t.shadowOffsetY = p(this.options.shadowStyle.shadowOffsetY, 0)), l(this.options.extraDrawFunc) && this.options.extraDrawFunc(t)
            ...
            return d(null == (i = this.props) ? void 0 : i.translateX) || (a.x = 0), d(null == (n = this.props) ? void 0 : n.translateY) || (a.y = 0), a
          }, t
        }(),
        x = function() {
          function t(t, e) {
            var i, n, a, o, r, s;
            this.options = t, this.partialWidth = this.options.width, this.partialHeight = this.options.height, this.rows = (null == (i = this.options.gridLayoutOptions) ? void 0 : i.rows) || 1, this.cols = (null == (n = this.options.gridLayoutOptions) ? void 0 : n.cols) || 1, this.matrix = (null == (a = this.options.gridLayoutOptions) ? void 0 : a.matrix) || (r = this.rows, s = this.cols, Array.from({
              length: r
            }, function() {
              return Array(s).fill(1)
            })), this.gap = (null == (o = this.options.gridLayoutOptions) ? void 0 : o.gap) || [0, 0], this.partialCanvas = e
          }
          return t.prototype.draw = function() {
            var t, e, i, n, a, o, r, s, l = w.createCanvas((null == (t = this.options.gridLayoutOptions) ? void 0 : t.width) || this.partialWidth * this.cols + this.gap[0] * this.cols, (null == (e = this.options.gridLayoutOptions) ? void 0 : e.height) || this.partialHeight * this.rows + this.gap[1] * this.rows),
              d = l.getContext("2d");
            ...
            for (var c = 0; c < this.rows; c++)
              for (var h = 0; h < this.cols; h++)(null == (s = null == (r = this.matrix) ? void 0 : r[c]) ? void 0 : s[h]) && (null == d || d.drawImage(this.partialCanvas, this.partialWidth * h + this.gap[0] * h, this.partialHeight * c + this.gap[1] * c, this.partialWidth, this.partialHeight));
            return l
          }, t
        }(),
        b = function(t, e) {
        ...
        S = function(t) {
          if ("grid" !== t.layout) return [t.width, t.height];
          var e, i, n, a = (null == (e = t.gridLayoutOptions) ? void 0 : e.cols) || 1,
            o = (null == (i = t.gridLayoutOptions) ? void 0 : i.rows) || 1,
            r = (null == (n = t.gridLayoutOptions) ? void 0 : n.gap) || [0, 0];
        ...
        k = function(t) {
          ...
          return n(i, t), i.prototype = null === t ? Object.create(t) : (e.prototype = t.prototype, new e), i.prototype.changeOptions = function() {
            return o(this, arguments, void 0, function(t, e, i) {
              return void 0 === t && (t = {}), void 0 === e && (e = "overwrite"), void 0 === i && (i = !0), r(this, function(n) {
                switch (n.label) {
                  case 0:
                    if (t.globalAlpha = .005, t.mode = "blind", this.initConfigData(t, e), f(this.options.monitorProtection), !i) return [3, 2];
            ...
            if (i && "canvas" === (void 0 === d ? "canvas" : d)) {
              var p = new Image;
              p.src = i, p.addEventListener("load", function() {
                var t = p.width,
                  e = p.height,
                  i = w.createCanvas(t, e),
                  n = i.getContext("2d");
                if (!n) throw Error("get context error");
                n.drawImage(p, 0, 0, t, e), n.globalCompositeOperation = r, n.fillStyle = a;
          ...
          function t(t) {
            void 0 === t && (t = {}), this.parentElement = document.body, this.isCreating = !1, this.props = t, this.options = a(a({}, y), t), this.changeParentElement(this.options.parent), this.watermarkCanvas = new w(this.props, this.options), f(this.options.monitorProtection)
          }
          return t.prototype.changeOptions = function() {
            return o(this, arguments, void 0, function(t, e, i) {
              return void 0 === t && (t = {}), void 0 === e && (e = "overwrite"), void 0 === i && (i = !0), r(this, function(n) {
                switch (n.label) {
                  case 0:
                    if (this.initConfigData(t, e), f(this.options.monitorProtection), !i) return [3, 2];
                    return this.remove(), [4, this.create()];
                  case 1:
                    n.sent(), n.label = 2;
                  case 2:
            ...
            var t, e, i, n, a, o, r, s;
            null == (e = (t = this.options).onBeforeDestroy) || e.call(t), null == (i = this.observer) || i.disconnect(), null == (n = this.parentObserve) || n.disconnect(), null == (o = null == (a = this.watermarkDom) ? void 0 : a.parentNode) || o.removeChild(this.watermarkDom), null == (s = (r = this.options).onDestroyed) || s.call(r)
            ...
            }) : this.props = t, this.options = a(a({}, y), this.props), this.changeParentElement(this.options.parent), this.watermarkCanvas = new w(this.props, this.options)
                ...
                return r(this, function(o) {
                  switch (o.label) {
                    ...
                    case 1:
                      ...
                      if ((null == (n = i[t]) ? void 0 : n.target) !== this.watermarkDom && (null == (a = null == n ? void 0 : n.removedNodes) ? void 0 : a[0]) !== this.watermarkDom && ("childList" !== n.type || n.target !== this.parentElement || n.target.lastChild === this.watermarkDom)) return [3, 3];
                      return this.remove(), [4, this.create()];
                    case 2:
                      o.sent(), o.label = 3;
                    case 3:
      ...
      ! function() {
        function t(t) {
          var e, i;
          void 0 === t && (t = {}), this.drew = !1, this.props = t, this.options = a(a({}, y), t), this.props.crossOrigin && (null == (e = this.props.dom) || e.setAttribute("crossOrigin", "anonymous")), this.watermarkCanvas = new w(this.props, this.options), this.originalSrc = null == (i = this.props.dom) ? void 0 : i.src, this.backgroundImage = this.getBackgroundImage()
        }
        t.prototype.create = function() {
          return o(this, void 0, void 0, function() {
            var t, e, i, n, o;
            return r(this, function(r) {
              switch (r.label) {
                ...
                case 1:
                  ...
                  }), this.layoutCanvas = b(this.options, null == (n = this.watermarkCanvas) ? void 0 : n.getCanvas()), this.options.dom.src = s(this.layoutCanvas), null == (o = this.watermarkCanvas) || o.clear(), this.drew = !0, [2]
              }
            })
          })
        }, t.prototype.destroy = function() {
