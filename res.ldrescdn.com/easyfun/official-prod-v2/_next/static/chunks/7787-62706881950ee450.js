        ...
        var r = {
            ...
            72: function(t, r, e) {
              ...
              function s(t, r, e) {
                ...
                if (C(t, ArrayBuffer) || t && C(t.buffer, ArrayBuffer) || "undefined" != typeof SharedArrayBuffer && (C(t, SharedArrayBuffer) || t && C(t.buffer, SharedArrayBuffer))) return function(t, r, e) {
                  var n;
              ...
              function A(t, r, e, n, o) {
                return r *= 1, e >>>= 0, o || E(t, r, e, 4, 34028234663852886e22, -34028234663852886e22), i.write(t, r, e, n, 23, 4), e + 4
              }

              function B(t, r, e, n, o) {
                return r *= 1, e >>>= 0, o || E(t, r, e, 8, 17976931348623157e292, -17976931348623157e292), i.write(t, r, e, n, 52, 8), e + 8
              }
              u.prototype.write = function(t, r, e, n) {
                ...
                for (var l = !1;;) switch (n) {
                  ...
                  case "utf8":
                  case "utf-8":
                    return i = r, o = e, S(x(t, this.length - i), this, i, o);
                  case "ascii":
            ...
            783: function(t, r) {
              r.read = function(t, r, e, n, i) {
                ...
                var f, u, s, h = 8 * o - i - 1,
                  ...
                  y = n ? 1 : -1,
                  g = +(r < 0 || 0 === r && 1 / r < 0);
                for (isNaN(r = Math.abs(r)) || r === 1 / 0 ? (u = +!!isNaN(r), f = a) : (f = Math.floor(Math.log(r) / Math.LN2), r * (s = Math.pow(2, -f)) < 1 && (f--, s *= 2), f + p >= 1 ? r += c / s : r += c * Math.pow(2, 1 - p), r * s >= 2 && (f++, s /= 2), f + p >= a ? (u = 0, f = a) : f + p >= 1 ? (u = (r * s - 1) * Math.pow(2, i), f += p) : (u = r * Math.pow(2, p - 1) * Math.pow(2, i), f = 0)); i >= 8; t[e + l] = 255 & u, l += y, u /= 256, i -= 8);
