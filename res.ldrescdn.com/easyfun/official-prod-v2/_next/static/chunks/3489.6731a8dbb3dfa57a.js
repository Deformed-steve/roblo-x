  ...
  [3489], {
    ...
    33489: (t, e, n) => {
      ...
      var m = function() {
            ...
            var t = function(t) {
              ...
              return function(t) {
                ...
                var i = d(t).getComputedStyle(t),
                  ...
                  a = p(i.width),
                  h = p(i.height);
                if ("border-box" === i.boxSizing && (Math.round(a + s) !== n && (a -= l(i, "left", "right") + s), Math.round(h + c) !== r && (h -= l(i, "top", "bottom") + c)), (e = t) !== d(e).document.documentElement) {
        ...
        y = function(t, e) {
          var n, r, i, o, s, c = (n = e.x, r = e.y, i = e.width, o = e.height, f(s = Object.create(("undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object).prototype), {
            x: n,
            y: r,
            width: i,
            height: o,
      ...
      var O = void 0 !== s.ResizeObserver ? s.ResizeObserver : E,
        ...
        k = n(73229),
        R = n(94907),
        x = (0, n(20891).A)(R.useLayoutEffect),
        z = T.A ? x : k.A;
      let D = function(t) {
        var e = (0, r.zs)((0, A.A)(function() {
            var e = (0, M.e)(t);
            return e ? {
              width: e.clientWidth,
