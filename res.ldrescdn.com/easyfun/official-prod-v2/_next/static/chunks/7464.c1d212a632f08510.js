  ...
  [6115, 7464], {
    15285: (e, t, n) => {
      ...
      function p() {
        let e = (0, o.c3)("cloud-game-area"),
          ...
          d = (0, u.useRef)(document.querySelector("#fullscreen-element"));
        return (0, r.jsxs)(h.m_, {
    ...
    18269: (e, t, n) => {
      ...
      function s(e) {
        let {
          className: t,
          ...n
        } = e, s = (0, i.useAtomValue)(c.Bp), [o, u] = (0, a.A)({
          leftTime: 1e3 * (s || 0)
        });
        return (0, l.jsxs)("div", {
          className: (0, r.A)("w-fit flex items-center rd-full bg-white-1 bg-op-5 p-1.5 pis-2", t),
          ...n,
    ...
    24148: (e, t, n) => {
      ...
      function g(e) {
        let {
          children: t
        } = e, n = (0, c.c3)("cloud-game-area"), l = (0, s.useRef)(document.querySelector("#fullscreen-element"));
        return (0, a.jsxs)(d.m_, {
    ...
    37545: (e, t, n) => {
      ...
      function b(e) {
        let t = (0, o.yF)((e, t) => {
          ...
          t(p.i7, l), n.send(w.LJ.AUDIO_MUTE, {
            muted: l
          });
          let a = e(p.vB),
            r = e(p.v0),
      ...
      function j(e) {
        let {
          children: t
        } = e, n = (0, u.c3)("cloud-game-area"), l = (0, d.useRef)(document.querySelector("#fullscreen-element"));
      ...
      function y() {
        let e = (0, s.useAtomValue)(p.i7),
          t = (0, d.useMemo)(() => e ? v : h, [e]);
        return (0, i.jsx)(t, {
          width: 16,
          height: 16,
          className: "size-4"
    ...
    38061: (e, t, n) => {
      ...
      function p(e) {
        let {
          children: t
        } = e, n = (0, s.c3)("cloud-game-area"), l = (0, o.useRef)(document.querySelector("#fullscreen-element"));
        return (0, r.jsxs)(f.m_, {
    ...
    46497: (e, t, n) => {
      ...
      function m(e) {
        let t = (0, r.yF)((e, t) => {
          ...
          i ? null == (l = window) || null == (n = l.g_setFullscreen) || n.call(l) : null == (r = window) || null == (a = r.g_exitFullscreen) || a.call(r), t(f.Gl, e => ({
            ...e,
            fullscreen: !i
          }))
        });
      ...
      function v(e) {
        let {
          children: t
        } = e, n = (0, i.c3)("cloud-game-area"), l = (0, c.useRef)(document.querySelector("#fullscreen-element"));
        return (0, a.jsxs)(u.m_, {
    ...
    48568: (e, t, n) => {
      ...
      function x(e) {
        let {
          children: t
        } = e, n = (0, o.c3)("cloud-game-area"), l = (0, u.useRef)(document.querySelector("#fullscreen-element"));
        return (0, a.jsxs)(h.m_, {
    ...
    70248: (e, t, n) => {
      ...
      function h(e) {
        let {
          children: t
        } = e, n = (0, i.c3)("cloud-game-area"), a = (0, c.useRef)(document.querySelector("#fullscreen-element"));
    ...
    75400: (e, t, n) => {
      ...
      function o(e) {
        ...
        return (0, l.jsx)(a.ZL, {
          container: c,
          children: (0, l.jsxs)(a.UC, {
            "data-slot": "tooltip-content",
            sideOffset: n,
            className: (0, r.A)("z-50 w-fit origin-[--radix-tooltip-content-transform-origin] rd-3 bg-black-3 px-3 py-1.5 c-white-1 c-op-90", "animate-keyframes-fade-in animate-duration-150", "data-[state=closed]:animate-keyframes-fade-out data-[state=closed]:animate-duration-150", t),
            ...s,
            children: [i, (0, l.jsx)(a.i3, {
    ...
    81715: (e, t, n) => {
      ...
      var l = n(64299),
        ...
        i = n(97117),
        c = n(54644);
      let s = (0, r.tG)("EASYFUN_USERINFO", {}, void 0, {
          getOnInit: !0
        }),
        o = (0, r.tG)("EASYFUN_LOGIN_SOURCE", c.Pf.UNKNOWN, void 0, {
          getOnInit: !0
        }),
        u = (0, l.eU)(void 0),
        d = (0, l.eU)(void 0),
        f = (0, r.tG)("EASYFUN_LAST_UPDATE_TOKEN", 0, void 0, {
          getOnInit: !0
        }),
        h = (0, r.mg)(s, e => !!(null == e ? void 0 : e.token)),
        m = (0, l.eU)(e => new Date - e(f) >= 432e5 && e(h)),
        v = (0, l.eU)(!1),
        g = (0, l.eU)(!1),
        p = (0, l.eU)(!1),
        x = (0, l.eU)(() => i.Jz.createLogin().auto()),
        w = (0, r.Rq)(x),
        b = (0, a.$)((e, t) => {
          if (e(m)) {
            let a = e(w);
            if ("hasData" === a.state) {
              if (t(f, +new Date), !a.data.email) {
                var n, l;
