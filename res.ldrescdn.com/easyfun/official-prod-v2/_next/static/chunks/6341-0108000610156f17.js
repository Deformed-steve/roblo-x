  ...
  [6341], {
    ...
    74673: (e, t, n) => {
      ...
      let r = n(96954),
        ...
        g = e => {
          ...
          l ? (y.innerHTML = l.__html || "", _()) : o ? (y.textContent = "string" == typeof o ? o : Array.isArray(o) ? o.join("") : "", _()) : t && (y.src = t, s.set(t, m)), (0, d.setAttributesFromProps)(y, e), "worker" === c && y.setAttribute("type", "text/partytown"), y.setAttribute("data-nscript", c), g && (e => {
      ...
      function y(e) {
        ...
        if ((0, o.useEffect)(() => {
            if (!x.current) {
              ...
              else "lazyOnload" === d && ("complete" === document.readyState ? (0, u.requestIdleCallback)(() => g(e)) : window.addEventListener("load", () => {
                (0, u.requestIdleCallback)(() => g(e))
              }));
              x.current = !0
            }
          }, [e, d]), ("beforeInteractive" === d || "worker" === d) && (y ? (m[d] = (m[d] || []).concat([{
            id: t,
            src: n,
            onLoad: r,
            onReady: a,
          ...
          if (p && p.forEach(e => {
            ...
            if (!n) return _.dangerouslySetInnerHTML && (_.children = _.dangerouslySetInnerHTML.__html, delete _.dangerouslySetInnerHTML), (0, l.jsx)("script", {
              nonce: b,
              dangerouslySetInnerHTML: {
            ...
            else return i.default.preload(n, _.integrity ? {
              as: "script",
    ...
    92968: (e, t, n) => {
      ...
      Object.defineProperty(t, "__esModule", {
        ...
        return void 0 === r && (r = o), (0, l.useEffect)(() => {
          performance.mark("mark_feature_usage", {
            detail: {
